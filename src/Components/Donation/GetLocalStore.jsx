...
const GetLocalStore = ({card}) => {
    ...
    return (
        <div style={{backgroundColor: card_bg}} className="md:flex rounded-xl gap-5 ">
                <img src={picture} alt="" className="w-full md:w-56 h-52 rounded-t-md md:rounded-l-xl"/>
            <div className="my-6 px-5 md:px-0">
                <spam style={{backgroundColor: category_bg, color: text_color}} className="text-base rounded-md font-normal capitalize px-4 py-1 ">{category}
                </spam>
